...
export default function DetailImage() {
    ...
    return (
        <div className='flex flex-col items-center lg:items-baseline lg:flex-row gap-5 px-2 mt-5'>
            ...
            <p className='w-full md:w-4/5 xl:w-1/2 text-center lg:text-start'>
                With a strong foundation in web technology and design, I am committed to building engaging and user-friendly sites. I am enthusiastic about bringing my skills and creativity to the tech industry and contributing to innovative projects.
            </p>
        </div>
    )
}
